...
function App() {
    ...
    const renderModalAvaliacao = (alunoData, fecharModal) => {
        ...
        return (
            <div className="fixed inset-0 z-[1000] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" onClick={fecharModal}>
                <div className="w-full max-w-md bg-[#16171d] border-2 border-neutral-800 rounded-3xl p-6 relative shadow-2xl max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                    <button onClick={fecharModal} className="absolute top-4 right-4 text-neutral-400 hover:text-white font-black text-lg bg-[#0d0e12] w-8 h-8 rounded-lg flex items-center justify-center border border-neutral-800">✕</button>
                    ...
                    <div className="flex items-center gap-3 mb-6 border-b border-neutral-800 pb-4">
                        ...
                        <div>
                            <h3 className="font-black text-white uppercase text-base tracking-tight">Avaliação Física</h3>
                            <p className="text-xs text-blue-400 font-black font-mono uppercase mt-1">{alunoData.nome}</p>
                        </div>
                    </div>

                    {/* 🚀 NOVO RADAR DE EVOLUÇÃO VISUAL */}
                    <div className="bg-[#0d0e12] border-2 border-neutral-800 p-5 rounded-2xl mb-6 shadow-inner">
                        <p className="text-xs font-black uppercase tracking-wider text-emerald-400 mb-4 flex items-center gap-2">
                            <span>🚀</span> Radar de Evolução Visual
                        </p>

                        <div className="mb-5">
                            <div className="flex justify-between text-xs uppercase font-black text-neutral-300 mb-2">
                            ...
                            <p className="text-[10px] font-bold text-right mt-2 text-neutral-400 font-mono uppercase">Proximidade do objetivo: {Math.round(Math.min(progressoMeta, 100))}%</p>
                        </div>
                        ...
                        {bf === 0 && (
                            <div className="pt-3 border-t border-neutral-800/50 mt-4 text-center">
                                <p className="text-xs text-neutral-400 font-bold italic">Percentual de gordura não registrado nas dobras.</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            <p className="text-xs font-black uppercase tracking-wider text-neutral-400 mb-3">Dados Biométricos Gerais</p>
                            <div className="grid grid-cols-2 gap-3">
                                <div className="bg-[#0d0e12] border-2 border-neutral-800 p-4 rounded-xl shadow-sm">
                                    <p className="text-[11px] text-neutral-400 uppercase font-black mb-1">Peso Bruto</p>
                                    <p className="text-lg font-black text-white">{alunoData.peso ? alunoData.peso : '--'} <span className="text-xs text-neutral-400 font-bold">kg</span></p>
                                </div>
                                <div className="bg-[#0d0e12] border-2 border-neutral-800 p-4 rounded-xl shadow-sm">
                                    <p className="text-[11px] text-neutral-400 uppercase font-black mb-1">Estatura</p>
                                    <p className="text-lg font-black text-white">{alunoData.altura ? alunoData.altura : '--'} <span className="text-xs text-neutral-400 font-bold">m</span></p>
                                </div>
                                <div className="bg-[#0d0e12] border-2 border-neutral-800 p-4 rounded-xl shadow-sm">
                                    <p className="text-[11px] text-neutral-400 uppercase font-black mb-1">Idade</p>
                                    <p className="text-lg font-black text-white">{alunoData.idade ? alunoData.idade : '--'} <span className="text-xs text-neutral-400 font-bold">anos</span></p>
                                </div>
                                <div className="bg-[#0d0e12] border-2 border-neutral-800 p-4 rounded-xl shadow-sm">
                                    <p className="text-[11px] text-neutral-400 uppercase font-black mb-1">Gênero Bio</p>
                                    <p className="text-base font-black text-white mt-1">{alunoData.genero ? alunoData.genero : '--'}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#0d0e12] border-2 border-neutral-800 p-5 rounded-2xl space-y-4 shadow-sm">
                            <div>
                                <p className="text-[11px] text-neutral-400 uppercase font-black mb-1">Nível de Treino</p>
                                <p className="text-sm font-bold text-white">{alunoData.nivel ? alunoData.nivel : '--'}</p>
                            </div>
                            {alunoData.restricoes && (
                                <div className="pt-3 border-t border-neutral-800/50">
                                    <p className="text-[11px] text-neutral-400 uppercase font-black mb-1">Restrições Alimentares</p>
                                    <p className="text-sm font-bold text-white">{alunoData.restricoes}</p>
                                </div>
                            )}
                            {alunoData.lesoes && (
                                <div className="pt-3 border-t border-neutral-800/50">
                                    <p className="text-[11px] text-neutral-400 uppercase font-black mb-1">Histórico de Lesões</p>
                                    <p className="text-sm font-bold text-white">{alunoData.lesoes}</p>
                                </div>
                            )}
                        </div>
                        ...
                        {alunoData.medidas && Object.keys(alunoData.medidas).length > 0 && (
                            <div className="mt-6 bg-[#0d0e12] border-2 border-neutral-800 p-5 rounded-2xl shadow-sm">
                                <p className="text-xs font-black uppercase tracking-wider text-blue-400 mb-4 border-b border-neutral-800 pb-2">
                                    📏 Circunferências (cm)
                                </p>
                                <div className="grid grid-cols-2 gap-3">
                                    {Object.entries(alunoData.medidas).map(([key, value]) => {
                                        ...
                                        return (
                                            <div key={key} className="bg-[#16171d] border border-neutral-800 p-3 rounded-xl flex flex-col justify-center">
                                                <span className="text-[10px] text-neutral-400 uppercase font-black capitalize mb-1">{labelFormatada}</span>
                                                <span className="text-base font-mono text-white font-black">{value} <span className="text-xs text-neutral-500 font-bold">cm</span></span>
                                            </div>
                                        );
                                    })}
                                </div>
    ...
    if (etapa === "verificando") {
        return (
            <div className="fixed inset-0 bg-[#0d0e12] flex flex-col items-center justify-center z-50">
                <div className="w-16 h-16 border-4 border-emerald-500/20 border-t-emerald-500 rounded-full animate-spin mb-6 shadow-lg shadow-emerald-500/20"></div>
                <div className="text-sm text-neutral-300 font-black uppercase tracking-widest animate-pulse">Sincronizando Seu Perfil...</div>
            </div>
        );
    }
            ...
            <div className="home-container fixed inset-0 z-50 overflow-y-auto">
                <div className="home-content">
                    ...
                    <header className="home-header">
                        <div className="home-logo text-3xl">Treino Fit</div>
                        <div>
                            <button onClick={() => setEtapa("login")} className="text-white hover:text-emerald-400 font-black text-base bg-transparent border-none cursor-pointer transition-colors px-4 py-2">
                                Entrar
                            </button>
                        </div>
                    </header>
                    ...
                    <section className="home-hero">
                        <h1 className="home-hero-title text-5xl">Seu Personal e Nutricionista<br /><span>Impulsionados por Inteligência Artificial</span></h1>
                        <p className="home-subtitle font-bold text-xl text-neutral-300">Não tem acompanhamento profissional? Sem problemas. Nossa IA monta sua estrutura de treinos e rotina alimentar ideal de forma 100% personalizada e automática.</p>

                        {/* Botão conectado direto para o Login do Usuário Final */}
                        <button onClick={() => setEtapa("login")} className="home-btn home-btn-whatsapp py-5 px-10 text-lg shadow-[0_10px_30px_rgba(37,211,102,0.4)]">
                            <span style={{ marginRight: '12px', fontSize: '26px' }}>💬</span> Iniciar com WhatsApp
                        </button>
                    </section>
                    ...
                    <section className="home-section-block">
                        <div className="home-grid">
                            <div className="home-content-left text-left">
                                <h2 className="text-4xl">Você é Personal Trainer?<br /><span style={{ color: '#60efff' }}>Ganhe tempo e multiplique alunos.</span></h2>
                                <p className="font-bold text-lg text-neutral-300">Esqueça planilhas confusas. Deixe a IA estruturar a base das rotinas e os check-ins enquanto você foca no ajuste fino e no atendimento premium.</p>

                                {/* Botão conectado direto para o Login do Personal */}
                                <button onClick={() => setEtapa("login_personal")} className="home-btn home-btn-primary py-4 px-8 text-base shadow-[0_10px_30px_rgba(0,255,135,0.3)]">
                                    Acessar Painel do Personal
                                </button>
                            </div>
                            <div className="home-app-mockup text-left border-2 border-neutral-700">
                                <div className="home-mockup-header text-lg border-b-2">
                                    <span className="font-black">📊 Painel do Treinador</span>
                                    <span className="font-black opacity-50">v1.2</span>
                                </div>
                                <div className="home-feature-item font-bold text-base py-3"><span style={{ marginRight: '12px', fontSize: '22px' }}>🤖</span> Previsão inteligente de evolução</div>
                                <div className="home-feature-item font-bold text-base py-3"><span style={{ marginRight: '12px', fontSize: '22px' }}>📝</span> Criação de treinos automáticos</div>
                                <div className="home-feature-item font-bold text-base py-3"><span style={{ marginRight: '12px', fontSize: '22px' }}>✅</span> Histórico e Check-ins simplificados</div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="home-section-block">
                        <div className="home-grid" style={{ direction: 'rtl' }}>
                            <div className="home-content-left text-left" style={{ direction: 'ltr' }}>
                                <h2 className="text-4xl">A Área do Aluno<br /><span style={{ color: '#00ff87' }}>Tudo integrado e na palma da mão.</span></h2>
                                <p className="font-bold text-lg text-neutral-300">Seu personal te cadastrou? Acesse sua divisão exata de treinos diários e sua base alimentar calculada conforme suas metas.</p>

                                {/* Botão conectado direto para o Login do Aluno */}
                                <button onClick={() => setEtapa("login_aluno")} className="home-btn py-4 px-8 text-base shadow-[0_10px_30px_rgba(0,255,135,0.1)] hover:bg-[#00ff87]/10" style={{ background: 'transparent', border: '2px solid #00ff87', color: '#00ff87' }}>
                                    Acessar Como Aluno
                                </button>
                            </div>
                            <div className="home-app-mockup text-left border-2 border-neutral-700" style={{ direction: 'ltr' }}>
                                <div className="home-mockup-header text-lg border-b-2">
                                    <span className="font-black text-white">💪 Meu Treino Diário</span>
                                    <span className="font-black text-orange-500">Meta Batida 🔥</span>
                                </div>
                                <div className="home-feature-item font-bold text-base py-3"><span style={{ marginRight: '12px', fontSize: '22px' }}>🍎</span> Base Alimentar Ajustada</div>
                                <div className="home-feature-item font-bold text-base py-3"><span style={{ marginRight: '12px', fontSize: '22px' }}>💧</span> Controle de Água Integrado</div>
                                <div className="home-notification-badge p-5 mt-4">
                                    <span style={{ fontSize: '28px' }}>💧</span>
                                    <div style={{ marginLeft: '16px', fontSize: '14px', textAlign: 'left', color: '#fff', fontWeight: 'bold' }}>
                                        <strong className="text-blue-300 text-sm">Notificação Treino Fit:</strong><br />
                    ...
                    <footer style={{ textAlign: 'center', padding: '40px 0', color: '#94a3b8', borderTop: '2px solid #1e293b', fontSize: '14px', fontWeight: 'bold' }}>
        ...
        return (
            <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
                <div className="fixed inset-0 bg-[#0d0e12] flex flex-col items-center justify-center p-6 text-white font-sans z-50">
                    <div className="w-full max-w-sm bg-[#16171d] border-2 border-neutral-800 p-8 rounded-[2rem] shadow-2xl">
                        {!googleUser ? (
                            <>
                                <h2 className="text-xl font-black uppercase tracking-tight text-white mb-2">Acesso Técnico</h2>
                                <p className="text-neutral-400 font-bold text-sm mb-8">Autentique-se com sua conta Google profissional.</p>
                                <div className="flex justify-center mb-8">
                                    <GoogleLogin onSuccess={handleGoogleSuccess} onError={() => alert('Falha no Login')} theme="filled_black" text="continue_with" />
                                </div>
                                <button type="button" onClick={() => setEtapa("triagem")} className="w-full bg-transparent border-2 border-neutral-800 hover:bg-neutral-800 p-4 rounded-xl text-sm uppercase tracking-wider text-neutral-300 transition-colors font-black">Voltar para Início</button>
                            </>
                        ) : (
                            <>
                                <div className="flex items-center gap-4 mb-6 bg-[#0d0e12] p-4 rounded-2xl border border-neutral-800">
                                    <img src={googleUser.foto} alt="Perfil" className="w-14 h-14 rounded-full border-2 border-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.3)]" />
                                    <div>
                                        <h2 className="text-base font-black text-white uppercase">{googleUser.nome}</h2>
                                        <p className="text-xs text-emerald-400 font-bold font-mono mt-1">Autenticação Concluída ✓</p>
                                    </div>
                                </div>
                                <p className="text-neutral-300 font-bold text-sm mb-6 leading-relaxed bg-blue-500/10 border border-blue-500/30 p-4 rounded-xl">Este é o seu primeiro acesso. Para ativar a sua licença no sistema Treino Fit, insira o seu <strong className="text-white">registo profissional (CREF)</strong> abaixo.</p>
                                <form onSubmit={handleCadastrarCref} className="space-y-4">
                                    <input required type="text" placeholder="Registro CREF (Ex: 123456-G/SP)" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-black outline-none focus:border-emerald-500 text-white placeholder-neutral-500 uppercase transition-colors" value={cref} onChange={(e) => setCref(e.target.value)} />
                                    <div className="flex gap-3 text-sm font-black pt-2">
                                        <button type="button" onClick={() => setGoogleUser(null)} className="w-1/3 bg-transparent border-2 border-neutral-800 hover:bg-neutral-800 p-4 rounded-xl uppercase tracking-wider text-neutral-300 transition-colors">Cancelar</button>
                                        <button type="submit" className="w-2/3 bg-emerald-600 hover:bg-emerald-500 text-white p-4 rounded-xl uppercase tracking-wider transition-colors shadow-[0_10px_20px_rgba(16,185,129,0.3)]">Validar Licença</button>
                                    </div>
                                </form>
                            </>
                        )}
    ...
    if (etapa === "login_aluno") {
        return (
            <div className="fixed inset-0 bg-[#0d0e12] flex flex-col items-center justify-center p-6 text-white font-sans z-50">
                <div className="w-full max-w-sm bg-[#16171d] border-2 border-neutral-800 p-8 rounded-[2rem] shadow-2xl">
                    <h2 className="text-2xl font-black uppercase tracking-tight text-white mb-2 text-center">Portal do Aluno</h2>
                    <p className="text-neutral-400 font-bold text-sm mb-8 text-center bg-[#0d0e12] p-4 rounded-xl border border-neutral-800">Insira o código de acesso fornecido pelo seu Personal Trainer para continuar.</p>
                    <form onSubmit={handleLoginAluno} className="space-y-5">
                        <input required type="text" placeholder="Código de Acesso (Ex: João Silva)" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4.5 rounded-xl text-base font-black outline-none focus:border-blue-500 text-white placeholder-neutral-500 text-center transition-colors" value={codigoAcessoAluno} onChange={(e) => setCodigoAcessoAluno(e.target.value)} />
                        <div className="flex flex-col gap-3 font-black">
                            <button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 text-white p-4.5 rounded-xl text-sm uppercase tracking-wider transition-colors shadow-[0_10px_20px_rgba(37,99,235,0.3)]">Entrar no App</button>
                            <button type="button" onClick={() => setEtapa("triagem")} className="w-full bg-transparent border-2 border-neutral-800 hover:bg-neutral-800 p-4 rounded-xl text-sm uppercase tracking-wider text-neutral-400 transition-colors">Voltar para Início</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    if (etapa === "matricula_externa") {
        return (
            <div className="fixed inset-0 bg-[#0d0e12] flex flex-col items-center justify-center p-4 md:p-6 text-white font-sans z-50 overflow-y-auto">
                <div className="w-full max-w-md bg-[#16171d] border-2 border-neutral-800 p-6 md:p-8 rounded-[2rem] shadow-2xl my-auto">
                    <div className="text-center mb-8">
                        <span className="text-6xl mb-4 block drop-shadow-[0_0_15px_rgba(16,185,129,0.3)]">🤖</span>
                        <h2 className="text-2xl font-black uppercase tracking-tight text-emerald-400 mb-2">Auto-Avaliação IA</h2>
                        <p className="text-neutral-300 font-bold text-sm bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl">Preencha sua biometria com atenção. A Inteligência Artificial usará esses dados para estruturar a base do seu treino e da sua dieta.</p>
                    </div>
                    <form onSubmit={async (e) => {
                        ...
                        <div className="space-y-1">
                            <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Nome Completo</label>
                            <input required type="text" placeholder="Como devemos te chamar?" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-bold outline-none focus:border-emerald-500 placeholder-neutral-600 transition-colors" onChange={e => setPerfil({ ...perfil, nome: e.target.value })} />
                        </div>

                        <div className="space-y-1">
                            <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">WhatsApp (Apenas Números)</label>
                            <input required type="text" placeholder="Ex: 11999999999" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-bold outline-none focus:border-emerald-500 placeholder-neutral-600 transition-colors" onChange={e => setNovoAlunoForm({ ...novoAlunoForm, whatsapp: e.target.value })} />
                        </div>

                        <div className="grid grid-cols-3 gap-3">
                            <div className="space-y-1">
                                <label className="text-[10px] font-black uppercase tracking-wider text-neutral-400 ml-1">Peso (kg)</label>
                                <input required type="text" placeholder="Ex: 80.5" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-bold outline-none focus:border-emerald-500 placeholder-neutral-600 text-center transition-colors" onChange={e => setPerfil({ ...perfil, peso: e.target.value })} />
                            </div>
                            <div className="space-y-1">
                                <label className="text-[10px] font-black uppercase tracking-wider text-neutral-400 ml-1">Altura (m)</label>
                                <input required type="text" placeholder="Ex: 1.75" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-bold outline-none focus:border-emerald-500 placeholder-neutral-600 text-center transition-colors" onChange={e => setPerfil({ ...perfil, altura: e.target.value })} />
                            </div>
                            <div className="space-y-1">
                                <label className="text-[10px] font-black uppercase tracking-wider text-neutral-400 ml-1">Idade</label>
                                <input required type="number" placeholder="Ex: 28" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-bold outline-none focus:border-emerald-500 placeholder-neutral-600 text-center transition-colors" onChange={e => setPerfil({ ...perfil, idade: e.target.value })} />
                            </div>
                        </div>

                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                            <div className="space-y-1">
                                <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Gênero Biológico</label>
                                <select required className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-emerald-500 cursor-pointer transition-colors" onChange={e => setPerfil({ ...perfil, genero: e.target.value })}>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Objetivo Principal</label>
                                <select required className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-emerald-500 cursor-pointer transition-colors" onChange={e => setPerfil({ ...perfil, meta: e.target.value })}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1">
                                <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Nível de Treino</label>
                                <select required className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-emerald-500 cursor-pointer transition-colors" onChange={e => setPerfil({ ...perfil, nivel: e.target.value })}>
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Dias na Semana</label>
                                <select required className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-emerald-500 cursor-pointer transition-colors" onChange={e => setPerfil({ ...perfil, diasTreino: e.target.value })}>
                        ...
                        <div className="space-y-1 pt-2">
                            <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Restrições Alimentares? (Opcional)</label>
                            <input type="text" placeholder="Ex: Vegano, Intolerante a lactose..." className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none focus:border-emerald-500 placeholder-neutral-600 transition-colors" onChange={e => setPerfil({ ...perfil, restricoes: e.target.value })} />
                        </div>

                        <div className="space-y-1">
                            <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Lesões ou Dores? (Opcional)</label>
                            <input type="text" placeholder="Ex: Dor no joelho direito, Hérnia..." className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none focus:border-emerald-500 placeholder-neutral-600 transition-colors" onChange={e => setPerfil({ ...perfil, lesoes: e.target.value })} />
                        </div>

                        <button type="submit" className="w-full bg-emerald-600 hover:bg-emerald-500 text-white p-5 rounded-xl uppercase tracking-widest font-black text-sm shadow-[0_10px_30px_rgba(16,185,129,0.4)] mt-6 transition-all active:scale-95 flex justify-center items-center gap-2">
    ...
    if (etapa === "onboarding") {
        return (
            <div className="fixed inset-0 bg-[#0d0e12] flex flex-col items-center justify-center p-4 md:p-8 text-white z-50 overflow-y-auto font-sans">
                <div className="w-full max-w-md bg-[#16171d] border-2 border-neutral-800 p-6 md:p-8 rounded-[2rem] shadow-2xl my-auto relative">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-base font-black uppercase tracking-tight text-emerald-400">
                            {quizStep === 1 && "1. Seu Objetivo"}
                            {quizStep === 2 && "2. Sua Rotina"}
                            {quizStep === 3 && "3. Suas Preferências"}
                            {quizStep === 4 && "4. Perfil Físico"}
                        </h2>
                        <span className="text-xs font-bold font-mono text-neutral-400 bg-[#0d0e12] px-3 py-1.5 rounded-lg border border-neutral-800">Passo {quizStep} de 4</span>
                    </div>
                    <div className="w-full bg-[#0d0e12] h-2.5 rounded-full mb-8 overflow-hidden border border-neutral-800 shadow-inner">
                        <div className="bg-emerald-500 h-full transition-all duration-500 ease-out shadow-[0_0_10px_rgba(16,185,129,0.5)]" style={{ width: `${(quizStep / 4) * 100}%` }}></div>
                    </div>
                    {quizStep === 1 && (
                        <div className="space-y-5">
                            <p className="text-base text-white font-black leading-relaxed text-center mb-6">O que você quer que a nossa Inteligência Artificial construa para você hoje?</p>
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    <button key={obj.id} type="button" onClick={() => setPerfil({ ...perfil, meta: obj.id })}
                                        className={`w-full p-5 rounded-2xl flex items-center gap-5 transition-all border-2 ${perfil.meta === obj.id ? 'bg-emerald-500/10 border-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.2)]' : 'bg-[#0d0e12] border-neutral-800 hover:border-neutral-600'}`}>
                                        <span className="text-4xl">{obj.icone}</span>
                                        <div className="text-left">
                                            <p className={`font-black uppercase text-lg ${perfil.meta === obj.id ? 'text-emerald-400' : 'text-white'}`}>{obj.id}</p>
                                            <p className="text-xs font-bold text-neutral-400 mt-1">{obj.desc}</p>
                                        </div>
                                    </button>
                                ))}
                            </div>
                            <button type="button" onClick={avançarQuiz} className="w-full bg-emerald-600 hover:bg-emerald-500 text-white py-4.5 rounded-xl uppercase tracking-wider font-black text-sm shadow-[0_10px_20px_rgba(16,185,129,0.3)] mt-8 transition-all active:scale-95">Próximo Passo →</button>
                        </div>
                    )}
                    {quizStep === 2 && (
                        <div className="space-y-8">
                            <div className="bg-[#0d0e12] p-5 rounded-2xl border border-neutral-800">
                                <p className="text-sm font-black uppercase tracking-wider text-white mb-4 text-center">Qual o seu nível de experiência?</p>
                                <div className="grid grid-cols-3 gap-3">
                                    {["Iniciante", "Intermediário", "Avançado"].map(niv => (
                                        <button key={niv} type="button" onClick={() => setPerfil({ ...perfil, nivel: niv })}
                                            className={`py-4 rounded-xl text-xs font-black uppercase transition-all border-2 ${perfil.nivel === niv ? 'bg-emerald-600 border-emerald-500 text-white shadow-lg shadow-emerald-500/20' : 'bg-[#16171d] border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-white'}`}>
                                            {niv}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div className="bg-[#0d0e12] p-5 rounded-2xl border border-neutral-800">
                                <p className="text-sm font-black uppercase tracking-wider text-white mb-4 text-center">Quantos dias na semana quer treinar?</p>
                                <div className="grid grid-cols-4 gap-3">
                                    {["3", "4", "5", "6"].map(dias => (
                                        <button key={dias} type="button" onClick={() => setPerfil({ ...perfil, diasTreino: dias })}
                                            className={`py-4 rounded-xl text-2xl font-black transition-all border-2 ${perfil.diasTreino === dias ? 'bg-blue-600 border-blue-500 text-white shadow-lg shadow-blue-600/20' : 'bg-[#16171d] border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-white'}`}>
                                            {dias}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div className="flex gap-4 mt-8">
                                <button type="button" onClick={() => setQuizStep(1)} className="w-1/3 bg-transparent border-2 border-neutral-800 text-neutral-300 p-4 rounded-xl font-black text-sm transition-colors hover:bg-neutral-800">Voltar</button>
                                <button type="button" onClick={avançarQuiz} className="w-2/3 bg-emerald-600 hover:bg-emerald-500 text-white p-4 rounded-xl uppercase tracking-wider font-black text-sm shadow-[0_10px_20px_rgba(16,185,129,0.3)] transition-all active:scale-95">Continuar →</button>
                            </div>
                        </div>
                    )}
                    {quizStep === 3 && (
                        <div className="space-y-6">
                            <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl mb-4">
                                <div className="flex justify-between items-center mb-2">
                                    <p className="text-sm text-white font-bold leading-relaxed pr-4">Selecione até 5 alimentos que você <span className="text-emerald-400 font-black uppercase tracking-wider">não quer que falte</span> na sua dieta.</p>
                                    <div className="flex flex-col items-center justify-center bg-[#0d0e12] border-2 border-emerald-500/50 text-emerald-400 w-12 h-12 rounded-full font-black text-sm shadow-[0_0_15px_rgba(16,185,129,0.3)] flex-shrink-0">
                                        {alimentosFavoritos.length}/5
                                    </div>
                                </div>
                            </div>
                            <div className="grid grid-cols-3 gap-3 max-h-[350px] overflow-y-auto pr-2 custom-scrollbar pb-2">
                                {[
                                    ...
                                    return (
                                        <button key={ali.nome} type="button" onClick={() => toggleAlimento(ali.nome)}
                                            className={`flex flex-col items-center justify-center p-4 rounded-2xl border-2 transition-all ${selecionado ? 'bg-orange-500/20 border-orange-500 shadow-[0_0_15px_rgba(249,115,22,0.3)] scale-105' : 'bg-[#0d0e12] border-neutral-800 hover:border-neutral-600 hover:bg-[#16171d]'}`}>
                                            <span className="text-4xl mb-2 drop-shadow-md">{ali.emoji}</span>
                                            <span className={`text-[11px] font-black uppercase text-center tracking-tight ${selecionado ? 'text-orange-400' : 'text-neutral-400'}`}>{ali.nome}</span>
                                        </button>
                                    );
                                })}
                            </div>
                            <div className="flex gap-4 mt-8 pt-4 border-t border-neutral-800">
                                <button type="button" onClick={() => setQuizStep(2)} className="w-1/3 bg-transparent border-2 border-neutral-800 text-neutral-300 p-4 rounded-xl font-black text-sm transition-colors hover:bg-neutral-800">Voltar</button>
                                <button type="button" onClick={avançarQuiz} className="w-2/3 bg-emerald-600 hover:bg-emerald-500 text-white p-4 rounded-xl uppercase tracking-wider font-black text-sm shadow-[0_10px_20px_rgba(16,185,129,0.3)] transition-all active:scale-95">Quase lá! →</button>
                            </div>
                        </div>
                    )}
                    {quizStep === 4 && (
                        <form onSubmit={finalizarQuiz} className="space-y-5">
                            <div className="bg-blue-500/10 border border-blue-500/30 p-5 rounded-2xl text-center mb-6 shadow-inner">
                                <span className="text-3xl mb-2 block">🧠</span>
                                <p className="text-sm font-bold text-neutral-200">Para a Inteligência Artificial calcular exatamente os seus macronutrientes e calorias diárias, precisamos dos seus dados vitais reais.</p>
                            </div>

                            <div className="space-y-1.5">
                                <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Como devemos te chamar?</label>
                                <input required type="text" placeholder="Seu nome" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-black outline-none text-white focus:border-emerald-500 placeholder-neutral-600 transition-colors" value={perfil.nome} onChange={(e) => setPerfil({ ...perfil, nome: e.target.value })} />
                            </div>

                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Gênero Biológico</label>
                                    <select required className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-emerald-500 cursor-pointer transition-colors" value={perfil.genero} onChange={(e) => setPerfil({ ...perfil, genero: e.target.value })}>
                                        <option value="Masculino">Masculino</option><option value="Feminino">Feminino</option>
                                    </select>
                                </div>
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Sua Idade</label>
                                    <input required type="number" placeholder="Anos" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-black outline-none text-white focus:border-emerald-500 placeholder-neutral-600 transition-colors text-center" value={perfil.idade} onChange={(e) => setPerfil({ ...perfil, idade: e.target.value })} />
                                </div>
                            </div>

                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Peso (kg)</label>
                                    <input required type="text" placeholder="Ex: 75.5" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-black outline-none text-white focus:border-emerald-500 placeholder-neutral-600 transition-colors text-center" value={perfil.peso} onChange={(e) => setPerfil({ ...perfil, peso: e.target.value })} />
                                </div>
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Altura (m)</label>
                                    <input required type="text" placeholder="Ex: 1.75" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-black outline-none text-white focus:border-emerald-500 placeholder-neutral-600 transition-colors text-center" value={perfil.altura} onChange={(e) => setPerfil({ ...perfil, altura: e.target.value })} />
                                </div>
                            </div>

                            <div className="space-y-1.5 pt-2">
                                <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Restrições Alimentares? (Opcional)</label>
                                <input type="text" placeholder="Ex: Vegano, Intolerante a lactose..." className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-emerald-500 placeholder-neutral-600 transition-colors" value={perfil.restricoes} onChange={(e) => setPerfil({ ...perfil, restricoes: e.target.value })} />
                            </div>

                            <div className="space-y-1.5">
                                <label className="text-xs font-black uppercase tracking-wider text-neutral-400 ml-1">Lesões ou Dores? (Opcional)</label>
                                <input type="text" placeholder="Ex: Dor no joelho direito, lombar..." className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-emerald-500 placeholder-neutral-600 transition-colors" value={perfil.lesoes} onChange={(e) => setPerfil({ ...perfil, lesoes: e.target.value })} />
                            </div>

                            <div className="flex gap-4 pt-6 border-t border-neutral-800 mt-2">
                                <button type="button" onClick={() => setQuizStep(3)} className="w-1/3 bg-transparent border-2 border-neutral-800 text-neutral-300 p-4 rounded-xl font-black text-sm transition-colors hover:bg-neutral-800">Voltar</button>
                                <button type="submit" className="w-2/3 bg-emerald-600 hover:bg-emerald-500 text-white p-4 rounded-xl uppercase tracking-wider font-black text-sm shadow-[0_10px_30px_rgba(16,185,129,0.4)] transition-all active:scale-95 flex items-center justify-center gap-2">
                                    ...
                                    <div key={idUnico} className={`bg-[#0d0e12] border-2 border-neutral-800 p-6 rounded-3xl flex flex-col space-y-5 shadow-lg ${aluno.statusConta === 'Off' ? 'opacity-50 grayscale-[50%]' : ''}`}>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="bg-[#16171d] p-4 rounded-2xl border border-neutral-800/50 shadow-inner flex flex-col justify-center">
                                                ...
                                                {checkinDeHoje ? (
                                                    <button type="button" onClick={() => setAlunoVerFeedback(aluno)} className="text-xs font-black text-emerald-400 bg-emerald-500/10 border border-emerald-500/30 px-3 py-1.5 rounded-lg animate-pulse cursor-pointer w-full shadow-sm">
                                                        🔥 HOJE!
                                                    </button>
                                                ) : aluno.checkins && aluno.checkins.length > 0 ? (
                    ...
                    <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-md flex items-center justify-center p-4">
                        <div className="w-full max-w-4xl bg-[#16171d] border-2 border-neutral-800 rounded-[2rem] shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col max-h-[95vh] h-full sm:h-auto">
                            ...
                            <form onSubmit={salvarTreinoPersonal} className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 custom-scrollbar">
                                ...
                                <div className="bg-[#0d0e12] border-2 border-neutral-800 p-6 rounded-3xl shadow-sm">
                                    <div className="flex items-center gap-3 mb-6 border-b-2 border-neutral-800/60 pb-4">
                                        <span className="text-2xl">🏋️‍♂️</span>
                                        <p className="text-base font-black uppercase tracking-widest text-neutral-300">Estrutura de Exercícios Semanal</p>
                                    </div>

                                    <div className="flex gap-2 overflow-x-auto pb-4 border-b-2 border-neutral-800/40 mb-6 scrollbar-none snap-x">
                                        {DIAS_SEMANA.map(dia => (
                                            <button
                                                key={dia}
                                                type="button"
                                                onClick={() => setDiaAbaPersonal(dia)}
                                                className={`px-6 py-3.5 rounded-2xl text-xs font-black uppercase transition-all flex-shrink-0 border-2 snap-center ${diaAbaPersonal === dia
                                                    ? 'bg-neutral-800 border-emerald-500 text-emerald-400 shadow-[0_5px_15px_rgba(16,185,129,0.2)] scale-105'
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 bg-[#16171d] p-4 rounded-xl border border-neutral-800 gap-4 sm:gap-0">
                                        <p className="text-sm font-mono text-emerald-400 font-black uppercase tracking-widest flex items-center gap-2">
                                            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                                            Ficha de {diaAbaPersonal}
                                        </p>
                                        <button type="button" onClick={adicionarExercicioForm} className="w-full sm:w-auto bg-emerald-600/10 text-emerald-400 border-2 border-emerald-500/40 text-xs font-black px-5 py-3 rounded-xl hover:bg-emerald-600/20 hover:scale-105 transition-all uppercase shadow-sm flex items-center justify-center gap-2">
                                    ...
                                    <div className="space-y-4">
                                        {(() => {
                                            ...
                                            if (diaObj.exercicios.length === 0) {
                                                return <p className="text-sm text-neutral-500 font-black uppercase italic text-center py-10 bg-[#16171d] rounded-2xl border-2 border-neutral-800 border-dashed">Nenhum exercício para este dia.<br /><span className="text-xs text-neutral-600 mt-2 block normal-case font-bold">O aluno verá como "Dia de Descanso".</span></p>;
                                            }

                                            return diaObj.exercicios.map((ex, idx) => (
                                                <div key={idx} className="bg-[#16171d] border-2 border-neutral-800 hover:border-neutral-700 p-5 sm:p-6 rounded-2xl space-y-5 relative group shadow-md transition-colors">
                                                    <div className="absolute top-4 right-4 z-10">
                                                        <button type="button" onClick={() => removerExercicioForm(idx)} className="text-neutral-500 hover:text-white bg-[#0d0e12] hover:bg-red-600 border border-neutral-700 hover:border-red-500 text-[10px] uppercase font-mono font-black tracking-widest transition-colors px-3 py-1.5 rounded-lg flex items-center gap-1 shadow-sm">✕ Remover</button>
                                                    </div>

                                                    <div className="flex items-center gap-3 mb-2 border-b border-neutral-800/60 pb-3 pr-24">
                                                        <div className="bg-neutral-800 text-neutral-400 font-black text-xs px-3 py-1 rounded-md font-mono">{idx + 1}</div>
                                                        <p className="text-xs font-black uppercase text-neutral-500 tracking-widest">Detalhes do Movimento</p>
                                                    </div>

                                                    <div className="grid grid-cols-1 sm:grid-cols-12 gap-5">
                                                        <div className="sm:col-span-6">
                                                            <label className="text-[11px] uppercase font-black text-neutral-400 block mb-2 tracking-wider">Nome do Exercício</label>
                                                            <input required type="text" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-bold outline-none text-white focus:border-emerald-500/70 transition-colors placeholder-neutral-600" value={ex.nome} onChange={(e) => handleExercicioChange(idx, "nome", e.target.value)} placeholder="Ex: Supino Reto com Halteres" />
                                                        </div>
                                                        <div className="sm:col-span-3">
                                                            <label className="text-[11px] uppercase font-black text-neutral-400 block mb-2 tracking-wider">Qtd. Séries</label>
                                                            <div className="relative">
                                                                <input required type="number" min="1" max="10" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-black outline-none text-white focus:border-emerald-500/70 transition-colors text-center pr-10" value={ex.series} onChange={(e) => handleExercicioChange(idx, "series", Number(e.target.value))} />
                                                                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-500 font-black text-xs uppercase">x</span>
                                                            </div>
                                                        </div>
                                                        <div className="sm:col-span-3">
                                                            <label className="text-[11px] uppercase font-black text-neutral-400 block mb-2 tracking-wider">Repetições</label>
                                                            <input required type="text" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-base font-black outline-none text-white focus:border-emerald-500/70 transition-colors text-center placeholder-neutral-600" value={ex.reps} onChange={(e) => handleExercicioChange(idx, "reps", e.target.value)} placeholder="8 a 12" />
                                                        </div>
                                                        <div className="sm:col-span-12 pt-2 border-t border-neutral-800/40">
                                                            <label className="text-[11px] uppercase font-black text-neutral-400 block mb-2 tracking-wider flex items-center gap-2"><span>📌</span> Observação / Instrução do Coach (Opcional)</label>
                                                            <input type="text" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-emerald-400 focus:border-emerald-500/70 transition-colors placeholder-neutral-700 italic" value={ex.obs || ""} onChange={(e) => handleExercicioChange(idx, "obs", e.target.value)} placeholder="Ex: Focar na fase excêntrica, 3 segundos descendo..." />
                                                        </div>
                                                    </div>
                                                </div>
                                            ));
                                ...
                                <div className="bg-[#0d0e12] border-2 border-neutral-800 p-6 rounded-3xl shadow-sm">
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-5 border-b-2 border-neutral-800/60 mb-6 gap-4 sm:gap-0">
                                        <div className="flex items-center gap-3">
                                            <span className="text-2xl">🍽️</span>
                                            <p className="text-base font-black uppercase tracking-widest text-neutral-300">Planejamento Nutricional</p>
                                        </div>
                                        <button type="button" onClick={adicionarDietaForm} className="w-full sm:w-auto bg-blue-600/10 text-blue-400 border-2 border-blue-500/40 text-xs font-black px-5 py-3 rounded-xl hover:bg-blue-600/20 hover:scale-105 transition-all uppercase shadow-sm flex items-center justify-center gap-2">
                                            <span className="text-lg leading-none">+</span> Nova Refeição
                                        </button>
                                    </div>
                                    <div className="space-y-4">
                                        {dietaForm.length === 0 && (
                                            <p className="text-sm text-neutral-500 font-black uppercase italic text-center py-6 bg-[#16171d] rounded-2xl border-2 border-neutral-800 border-dashed mb-2">Plano alimentar vazio.</p>
                                        )}
                                        {dietaForm.map((ref, idx) => (
                                            <div key={idx} className="bg-[#16171d] border-2 border-neutral-800 p-5 rounded-2xl flex flex-col sm:flex-row gap-5 relative sm:items-start shadow-md hover:border-neutral-700 transition-colors pt-10 sm:pt-5 pr-5 sm:pr-16">
                                                <div className="absolute top-4 left-4 sm:hidden bg-neutral-800 text-neutral-400 font-black text-[10px] px-2 py-1 rounded font-mono">Refeição {idx + 1}</div>

                                                <div className="w-full sm:w-1/3">
                                                    <label className="text-[11px] uppercase font-black text-neutral-400 block mb-2 tracking-wider">Horário / Nome</label>
                                                    <input required type="text" placeholder="Ex: Café da Manhã (08:00)" className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-blue-500/70 transition-colors placeholder-neutral-600" value={ref.refeicao} onChange={(e) => handleDietaChange(idx, "refeicao", e.target.value)} />
                                                </div>
                                                <div className="w-full sm:w-2/3">
                                                    <label className="text-[11px] uppercase font-black text-neutral-400 block mb-2 tracking-wider">Alimentos e Quantidades</label>
                                                    <input required type="text" placeholder="Ex: 3 Ovos inteiros, 2 fatias de pão integral..." className="w-full bg-[#0d0e12] border-2 border-neutral-700 p-4 rounded-xl text-sm font-bold outline-none text-white focus:border-blue-500/70 transition-colors placeholder-neutral-600" value={ref.itens} onChange={(e) => handleDietaChange(idx, "itens", e.target.value)} />
                                                </div>

                                                <button type="button" onClick={() => removerDietaForm(idx)} className="absolute top-4 right-4 text-neutral-500 hover:text-white font-black text-lg bg-[#0d0e12] hover:bg-red-600 border border-neutral-700 hover:border-red-500 w-10 h-10 rounded-xl flex items-center justify-center transition-colors shadow-sm" title="Remover refeição">✕</button>
                                            </div>
                                        ))}
                                    </div>
                                </div>

                                <footer className="pt-8 mt-4 border-t-2 border-neutral-800 flex flex-col sm:flex-row gap-4 justify-end text-sm font-black sticky bottom-0 bg-[#16171d] pb-6 sm:pb-0 z-20">
                                    <button type="button" onClick={() => setAlunoEmEdicao(null)} className="bg-[#0d0e12] border-2 border-neutral-700 text-neutral-300 p-5 rounded-xl uppercase tracking-widest hover:bg-neutral-800 hover:text-white transition-colors w-full sm:w-auto text-center">Cancelar Alterações</button>
                                    <button type="submit" className="bg-emerald-600 hover:bg-emerald-500 text-white p-5 rounded-xl uppercase tracking-widest transition-all shadow-[0_15px_30px_rgba(16,185,129,0.3)] px-10 w-full sm:w-auto text-center active:scale-95 flex items-center justify-center gap-2">
                                        <span>✓</span> Salvar Planilhas e Enviar para Aluno
                                    </button>
                                </footer>
                            </form>
                        </div>
                ...
                <main className="w-full max-w-md mx-auto flex-1 space-y-6 pb-10">
                            ...
                            <div className="border-t-2 border-neutral-800/60 pt-5 mt-2">
                                ...
                                <div className="grid grid-cols-3 gap-3 mb-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min="0" max="23" className="w-full bg-[#0d0e12] border-2 border-neutral-800 p-3 rounded-xl text-base font-black text-white outline-none focus:border-blue-500/50 text-center" value={configAgua.horaFim} onChange={e => setConfigAgua({ ...configAgua, horaFim: e.target.value })} />
                                    </div>
                                    <div>
                                        <label className="text-[10px] font-black text-neutral-400 uppercase">Intervalo</label>
                                        <select className="w-full bg-[#0d0e12] border-2 border-neutral-800 p-3 rounded-xl text-sm font-black text-white outline-none focus:border-blue-500/50 text-center" value={configAgua.intervaloHoras} onChange={e => setConfigAgua({ ...configAgua, intervaloHoras: e.target.value })}>
                    ...
                    {modalGifAberto && (
                        <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-md flex items-center justify-center p-4" onClick={() => setModalGifAberto(null)}>
                            <div className="w-full max-w-sm bg-[#16171d] border-2 border-sky-500/50 rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(14,165,233,0.3)] relative" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="w-full max-w-[340px] bg-gradient-to-br from-neutral-900 to-[#0d0e12] border-2 border-emerald-500/40 rounded-[2rem] p-6 md:p-8 relative shadow-[0_0_60px_rgba(16,185,129,0.3)] flex flex-col items-center" onClick={e => e.stopPropagation()}>
                                ...
                                <div id="instagram-card" className="w-full aspect-[9/16] bg-gradient-to-b from-emerald-900/30 to-[#0d0e12] border-2 border-emerald-500/30 rounded-[2rem] flex flex-col items-center justify-between p-6 md:p-8 relative overflow-hidden mb-8 shadow-inner">
                                    ...
                                    <div className="w-full space-y-4 my-auto z-10">
                                        <div className="bg-[#16171d]/90 backdrop-blur-md border border-neutral-600/50 p-5 rounded-2xl text-center shadow-lg">
                                            <p className="text-[10px] uppercase text-neutral-400 font-black mb-1.5 tracking-wider">Foco de Hoje</p>
                                            <p className="text-lg font-black text-white uppercase">{dadosShare.treino}</p>
                                        </div>
                                        <div className="flex gap-3">
                                            <div className="flex-1 bg-[#16171d]/90 backdrop-blur-md border border-neutral-600/50 p-4 rounded-2xl text-center shadow-lg">
                                                <p className="text-[10px] uppercase text-neutral-400 font-black mb-1.5 tracking-wider">Intensidade</p>
                                                <p className="text-base font-black text-emerald-400 uppercase truncate">{dadosShare.intensidade.split(" ")[0]}</p>
                                            </div>
                                            <div className="flex-1 bg-[#16171d]/90 backdrop-blur-md border border-neutral-600/50 p-4 rounded-2xl text-center shadow-lg">
                                                <p className="text-[10px] uppercase text-neutral-400 font-black mb-1.5 tracking-wider">Carga</p>
                                                <p className="text-base font-black text-blue-400 uppercase truncate">{dadosShare.carga.split(" ")[0]}</p>
                                            </div>
                                        </div>
                                    </div>
