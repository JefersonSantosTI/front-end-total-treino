...
export default function HomeUsuario({ setEtapa }) {
    return (
        <div className="min-h-screen bg-zinc-950 text-zinc-200 font-sans selection:bg-orange-500 selection:text-white">
            ...
            {/* 2. PROVA SOCIAL (Resultados Reais) */}
            <section className="py-24 px-6 max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {/* Card 1 */}
                    <div className="bg-zinc-900 rounded-3xl p-5 shadow-2xl border border-zinc-800 hover:border-orange-500/50 transition-colors group">
                        <div className="flex gap-2 mb-5 h-64 relative overflow-hidden rounded-2xl">
                            <img src="/lucas-transformacao.jpg" alt="Evolução Lucas" className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-gradient-to-t from-zinc-900 via-transparent to-transparent"></div>
                        </div>
                        <h3 className="font-black text-2xl mb-1 text-white uppercase">Lucas M.</h3>
                        ...
                        <p className="text-zinc-400 text-sm font-medium leading-relaxed">"O cálculo de macros da IA foi cirúrgico. Pela primeira vez consegui secar mantendo a massa magra sem passar fome."</p>
                    </div>

                    {/* Card 2 */}
                    <div className="bg-zinc-900 rounded-3xl p-5 shadow-2xl border border-zinc-800 hover:border-orange-500/50 transition-colors group">
                        <div className="flex gap-2 mb-5 h-64 relative overflow-hidden rounded-2xl">
                            <img src="/mariana-transformacao.jpg" alt="Evolução Mariana" className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-gradient-to-t from-zinc-900 via-transparent to-transparent"></div>
                        </div>
                        <h3 className="font-black text-2xl mb-1 text-white uppercase">Mariana S.</h3>
                        ...
                        <p className="text-zinc-400 text-sm font-medium leading-relaxed">"Meu platô acabou na segunda semana. A progressão de carga que o app sugere faz toda a diferença nos treinos."</p>
                    </div>

                    {/* Card 3 */}
                    <div className="bg-zinc-900 rounded-3xl p-5 shadow-2xl border border-zinc-800 hover:border-orange-500/50 transition-colors group">
                        <div className="flex gap-2 mb-5 h-64 relative overflow-hidden rounded-2xl">
                            <img src="/lais-transformacao.jpg" alt="Evolução Lais" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-gradient-to-t from-zinc-900 via-transparent to-transparent"></div>
                        </div>
                        <h3 className="font-black text-2xl mb-1 text-white uppercase">Lais T.</h3>
                        ...
                        <p className="text-zinc-400 text-sm font-medium leading-relaxed">"Eu só tinha halteres em casa. A Inteligência Artificial adaptou minha ficha inteira e o resultado veio igual!"</p>
                    </div>
                </div>
            </section>
